...
public class ShellViewModel : ObservableObject
{
    ...
    public ObservableCollection<HamburgerMenuItem> MenuItems { get; } = new()
    {
        new HamburgerMenuGlyphItem
            { Label = Resources.ShellPaymentsPage, Glyph = "\ue8fd", TargetPageType = typeof(PaymentsViewModel) },
        new HamburgerMenuGlyphItem
            { Label = Resources.ShellCustomersPage, Glyph = "\ue716", TargetPageType = typeof(CustomersViewModel) },
        new HamburgerMenuGlyphItem
            { Label = Resources.ShellCategoriesPage, Glyph = "\ue8f1", TargetPageType = typeof(CategoriesViewModel) }
    };
